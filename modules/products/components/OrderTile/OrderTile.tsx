...
const OrderTile = ({ orderId, paymentStatus, items }: IOrderTileProps) => {
  ...
  return (
    <ul className='bg-gray-100 w-100 text-gray-600 hover:text-gray-700 shadow-2xl mt-3 rounded py-2 px-3 '>
      ...
      {items.map((item) => {
        ...
        return (
          <Link href={getProductHref(item.productName, item.id)} passHref>
            <li className='hover:shadow flex cursor-pointer items-center justify-between p-2 py-3 py-2 shadow-custom'>
