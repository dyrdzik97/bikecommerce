  ...
  return (
    <div className='max-w-sm rounded-lg bg-white shadow transition-shadow hover:shadow-lg'>
      ...
      <div className='p-5'>
        ...
        <a
          href={`/${url}`}
          className='bg-blue-700 hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center rounded-lg px-3 py-2 text-center text-sm font-medium text-white focus:outline-none focus:ring-4'
        >
          {buttonText}
          <svg
            aria-hidden='true'
